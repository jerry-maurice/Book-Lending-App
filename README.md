...
└── src
    ...
    ├── Book.js # detail about books
    ├── BookShelf.js # Categorize book into shelf
    ├── ListBook.js # Show all the book with there shelves
    ├── BooksAPI.js # A JavaScript API for the provided Udacity backend. Instructions for the methods are 
    ├── SearchBook.js # search for book and able to place them into a shelf.
